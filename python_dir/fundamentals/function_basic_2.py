...
# parameters: size and value. The function should create and return a list whose l
# ength is equal to the given size, and whose values are all the given value.
